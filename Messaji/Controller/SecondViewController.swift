...
class SecondViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
       ...
       let color = UIColor.colorLerp2(from: .white, to: .red, progress: 0.5)
    ...
    func UIset(){
        ...
        if saveData.object(forKey: "key_NameText2") != nil{
                NameText.backgroundColor = UIColor.colorLerp(from: .white, to: .red, progress: 0.5)
               }
               
                if saveData.object(forKey: "today2") != nil{
                    judgeDate()
                    DateLabel.backgroundColor = UIColor.colorLerp(from: .white, to: .red, progress: 0.5)
                 }
        
         self.AddImage.isUserInteractionEnabled = true
         NameText.text  = saveData.object(forKey: "key_NameText2") as? String
         TextView.text  = saveData.object(forKey: "key_TextView2") as? String
         if saveData.object(forKey: "key_AddImage2") != nil {
            let ImageData = saveData.data(forKey: "key_AddImage2")
    ...
    // 日時経過チェック
    if saveData.object(forKey: "today2") != nil {
         let past_day = saveData.object(forKey: "today2") as! Date
        ...
        //日にちが変わっていた場合
             ...
             //初回実行のみelse(nilならば、)
                 ...
                 judge = true
                 /* 今の日時を保存 */
                 saveData.set(now_day, forKey: "today2")
    ...
    @objc func updateColor() {
        ...
        let topColor = UIColor(red: 1.0, green: 1.0, blue: 0.6, alpha: 1.0)
        let bottomColor = UIColor(red: 0.6, green: 0.6, blue: 1.0, alpha: 1.0)
    ...
    @IBAction func save(_ sender: Any) {
        ...
        if saveData.object(forKey: "key_AddImage2") == nil {
            ...
            saveData.set(NameText.text, forKey: "key_NameText2")
            saveData.set(TextView.text, forKey: "key_TextView2")
            judgeDate()
            // 通知リクエストの登録
    ...
    extension UIColor {
        ...
        static func colorLerp2(from: UIColor, to: UIColor, progress: CGFloat) -> UIColor {
        ...
        func  imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
            ...
            self.saveData.set(data, forKey: "key_AddImage2")
            //imagepickerの削除
