...
class ThirdViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
       ...
       let color = UIColor.colorLerp3(from: .white, to: .red, progress: 0.5)
    ...
    func UIset(){
         ...
         TextView.text  = saveData.object(forKey: "key_TextView3") as? String
         if saveData.object(forKey: "key_AddImage3") != nil {
            let ImageData = saveData.data(forKey: "key_AddImage3")
    ...
    // 日時経過チェック
    if saveData.object(forKey: "today3") != nil {
         let past_day = saveData.object(forKey: "today3") as! Date
        ...
        //日にちが変わっていた場合
             ...
             //初回実行のみelse(nilならば、)
                 ...
                 judge = true
                 /* 今の日時を保存 */
                 saveData.set(now_day, forKey: "today3")
    ...
    @IBAction func save(_ sender: Any) {
        ...
        if saveData.object(forKey: "key_AddImage3") == nil {
            ...
            saveData.set(NameText.text, forKey: "key_NameText3")
            saveData.set(TextView.text, forKey: "key_TextView3")
            judgeDate()
            // 通知リクエストの登録
    ...
    extension UIColor {
        ...
        static func colorLerp3(from: UIColor, to: UIColor, progress: CGFloat) -> UIColor {
        ...
        func  imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
            ...
            self.saveData.set(data, forKey: "key_AddImage3")
            //imagepickerの削除
